															...
															<span style={{top: 30, position: "relative",}}>
																...
																{frameworkData !== undefined && frameworkData !== null && Object.keys(frameworkData).length > 0 ?
																	<WorkflowTemplatePopup 
																		...
																		srcapp={inputUsecase.srcapp === undefined || inputUsecase.srcapp === null ? "" : inputUsecase.srcapp}
																		img2={inputUsecase.dstimg}
																		dstapp={inputUsecase.dstapp === undefined || inputUsecase.dstapp === null ? "" : inputUsecase.dstapp}
